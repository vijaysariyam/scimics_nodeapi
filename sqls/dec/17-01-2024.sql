...
DROP TABLE IF EXISTS scimic_department;
CREATE TABLE IF NOT EXISTS scimic_department(
...
INSERT INTO scimic_department(department_name, college_id)
VALUES
    ('B.Tech', 1),
    ('MBA', 1);


ALTER TABLE scimic_course
ADD COLUMN department_id INTEGER;

UPDATE scimic_course
SET department_id = 1
WHERE course_pk = 1

ALTER TABLE scimic_user
ADD COLUMN department_id INTEGER;
