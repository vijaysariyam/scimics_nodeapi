...
(firstname, lastname, email, hashed_password, signin_source , is_account_verified)
VALUES('SUPER' , 'ADMIN' , 'superadmin@scimics.com' , '12345678' , 'EMAIL' , true );
...
insert into icap_categories(icap_category_name)VALUES('Technical Proficiency');
insert into icap_categories(icap_category_name)VALUES('Communication Skills');
insert into icap_categories(icap_category_name)VALUES('Personality and Behavioral');
...
insert into icap_subcategories
(icap_category_id , icap_subcategory_name , icap_subcategory_info)
VALUES(2 , 'Domain-Specific Knowledge' , 'None');
insert into icap_subcategories
(icap_category_id , icap_subcategory_name , icap_subcategory_info)
VALUES(2 , 'Hands-on Coding / Basic Computer Knowledge' , 'None');


insert into icap_subcategories
(icap_category_id , icap_subcategory_name , icap_subcategory_info)
VALUES(3 , 'English Speaking' , 'None');
insert into icap_subcategories
(icap_category_id , icap_subcategory_name , icap_subcategory_info)
VALUES(3 , 'English Listening' , 'None');
insert into icap_subcategories
(icap_category_id , icap_subcategory_name , icap_subcategory_info)
VALUES(3 , 'English Reading' , 'None');
insert into icap_subcategories
(icap_category_id , icap_subcategory_name , icap_subcategory_info)
VALUES(3 , 'English Writing' , 'None');
